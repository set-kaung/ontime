...
func (s *SQLiteUserRepository) GetUserByID(id int) (*User, error) {
...
func (s *SQLiteUserRepository) GetUserByUsername(username string) (*User, error) {
...
func (s *SQLiteUserRepository) GetUserByEmail(email string) (*User, error) {
...
func (s *SQLiteUserRepository) InsertUser(user *User) error {
	tx, err := s.db.Begin()
	if err != nil {
		return err
	}
...
func (s *SQLiteUserRepository) GetUserProfile(id int) (*User, error) {
	stmt := `
